...
log "1. Home Assistant neu starten."
log "2. Mapping-Vorschläge read-only erzeugen:"
log "   python3 scripts/discover_entities.py --report ${SHARE%/}/se_controller_mapping_report.json --output config/site_config.env"
log "3. config/site_config.env manuell prüfen; SITE_CONFIG_CONFIRMED bleibt bis dahin NO."
log "4. Site-Konfiguration anwenden und First Checks ausführen."
log "5. Controller-Master erst nach PASS=True einschalten."
